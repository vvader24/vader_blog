...
::: columns
::: {.column .aside width="80%"}
<center><a href='https://vvader.netlify.app' target='_blank'> ![](images/picture_vader.jpeg){width="80%" style="border-radius: 50%;"}</center>
...
Resume made with 💜 and [Quarto](https://quarto.org/). Last updated on `r format.Date(Sys.Date(), "%b %d, %Y")`. <br> Code available on <i class="fa-brands fa-github"></i> [GitHub](https://github.com/vvader24/vader_blog/blob/main/cv/Vader_resume.qmd). <br>License: [CC BY-SA 2.0](https://creativecommons.org/licenses/by-sa/2.0/).
