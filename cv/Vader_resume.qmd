...
<i class="fab fa-r-project"></i> `R` <br> <i class="fa fa-area-chart" aria-hidden="true"></i> `tidyverse` <br> <i class="fab fa-markdown"></i> `RMarkdown/Quarto` <br> <i class="fas fa-code-branch"></i> `Git/Gitkraken` <br> <i class="fab fa-github"></i> `GitHub` <br> <i class="fab fa-markdown"></i> `Markdown` <br> <i class="fab fa-html5"></i> `HTML` <br> <i class="fab fa-css3-alt"></i> `CSS` <br><i class="fa-brands fa-microsoft"></i> `Microsoft Office` <br><i class="fa-solid fa-chart-line"></i>`SPSS` <br>

### Recognition

Sundberg Fellowship for Cross-cultural research (2020, 2021).<br> Reviewer for [Personality and Social Psychology Review Journal](https://us.sagepub.com/en-us/nam/journal/personality-and-social-psychology-review#editorial-board)
